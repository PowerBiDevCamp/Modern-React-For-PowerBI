...
const Report = () => {
    ...
    const [embedType, setEmbedType] = useState<"ExistingReport" | "NewReport" | "PaginatedReport" | null>(null);
    ...
    const setReportContainerHeight = () => {
        console.log("setReportContainerHeight");
    ...
    useEffect(() => {
        ...
        const useEffectAsync = async () => {
            ...
            console.log("ERROR - Bad URL - " + path);
    ...
    if (!isAuthenticated) {
        ...
        return (
            <Box sx={{ display: "grid", gridAutoFlow: "row", width: 1 }}>
                ...
                {embedType === "ExistingReport" && <ReportToolbar report={embeddedReport}
